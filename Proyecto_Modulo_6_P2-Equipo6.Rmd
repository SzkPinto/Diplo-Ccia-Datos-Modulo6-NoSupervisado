...
---
# Introducción 
El presente trabajo corresponde a la segunda parte del proyecto de análisis aplicado 
a la base Sleep Health and Lifestyle. En la primera fase se realizó una exploración 
inicial de los datos, enfocada en la limpieza, el preprocesamiento y la aplicación 
de técnicas de reducción de dimensionalidad para visualizar posibles patrones en
las variables.

En esta Parte 2 retomamos la misma base de datos utilizada en el proyecto anterior,
con el propósito de dar continuidad y ampliar la profundidad del análisis. 
Ahora el énfasis está en la aplicación y comparación de seis métodos de clustering:
...
Cada uno de estos algoritmos presenta ventajas y limitaciones particulares: algunos
requieren definir el número de clusters de antemano, otros detectan estructuras de 
densidad de manera jerárquica y algunos son más robustos al ruido.

El objetivo central de esta segunda etapa es evaluar cuál de estos enfoques ofrece 
una segmentación más coherente y significativa en los datos de salud y estilo de 
vida relacionados con el sueño, y analizar si las agrupaciones obtenidas guardan 
relación con las categorías existentes en la base (como los diferentes Sleep Disorders).

De esta manera, el proyecto busca no solo comparar el desempeño técnico de los 
algoritmos, sino también valorar la utilidad de cada método para generar insights 
aplicables en el ámbito de la salud y el bienestar.
...
Cuando cruzamos los resultados de cada Clústeres versus la etiqueta de Sueño, en general encontramos mezclas; en el caso de k-Means segmenta adecuadamente los pacientes sin padecimientos, pero lo que tienen algún padecimiento los mezcla, por lo que bajo este método podríamos concluir dos grupos con padecimiento y sin padecimiento.
K Medois:
DBSCAN:
HDBSCAN:
