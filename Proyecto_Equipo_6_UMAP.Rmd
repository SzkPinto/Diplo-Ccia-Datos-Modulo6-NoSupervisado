...
base_recipe %>% 
  ...
  xlim(c(0, 30)) + 
  labs(x="PC", y="% acumulado de varianza", title="Varianza Acumulada por Componente")
```
...
```{r}
umap_params = expand.grid(n_neighbors = c(10, 15, 20, 50, 100),min_dist = c(0.1, 0.5, 0.75, 1.1))
